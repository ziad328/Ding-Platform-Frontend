...
const SuggestedFollowers = () => {
    const followers = [
        { name: 'Isabella Carter', headline: 'Content Strategist' },
        { name: 'Noah Patel', headline: 'Growth Marketer' },
        { name: 'Maya Ibrahim', headline: 'AI Researcher' },
        { name: 'Felix Romero', headline: 'Product Lead' },
    ];

    return (
        <div className="bg-white rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 md:p-5 space-y-3">
            <h3 className="text-sm sm:text-base font-semibold text-neutral-b-900 mb-3 sm:mb-4">Suggested Followers</h3>
                    ...
                    <div key={index} className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-neutral-b-500 mt-0.5">{follower.headline}</p>
                            </div>
                        </div>
