...
export const ProfileHeaderSkeleton: React.FC = () => (
    <div className="bg-white dark:bg-dark-bg-secondary rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-3 sm:px-4 md:px-6 pb-2">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                <div className="flex-1">
                    <div className="relative -mt-10 sm:-mt-12 md:-mt-14 mb-3 sm:mb-4 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24">
                        <div className={`w-full h-full rounded-full border-4 border-white dark:border-dark-bg-secondary shadow-lg ${shimmer}`} />
                    </div>
            ...
            <div className="flex justify-around sm:justify-start border-t border-neutral-w-400 dark:border-dark-border mt-3 sm:mt-4 pt-1 gap-4 sm:gap-6">
                {[1, 2, 3].map((tab) => (
...
export const SuggestedFriendsSkeleton: React.FC = () => (
    <div className="bg-white dark:bg-dark-bg-secondary rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 md:p-5 overflow-hidden">
...
export const MyFriendsSkeleton: React.FC = () => (
    <div className="bg-white dark:bg-dark-bg-secondary rounded-lg sm:rounded-xl shadow-sm p-3 sm:p-4 md:p-5">
    ...
    <div className="bg-white dark:bg-dark-bg-secondary rounded-lg sm:rounded-xl shadow-sm overflow-hidden">
        <div className="flex flex-col sm:flex-row">
            ...
            <div className="flex-1 p-3 sm:p-4 md:p-6 space-y-4">
                <div className={`h-24 rounded-lg border-2 border-dashed border-neutral-w-400 dark:border-dark-border ${shimmer}`} />
                {[1, 2, 3].map((field) => (
